...
ST_retcode launch_edm_tasks(int argc, char* argv[])
{
  ...
  if (dtMode && opts.dtWeight == 0.0) {
    ...
    KeenManifold manifold = dtgenerator.create_manifold(maxE, {}, true, DT_WEIGHT);
  ...
  if (saveDT) {
    ...
    KeenManifold manifold = generator.create_manifold(maxE, {}, true, SAVE_DT_WEIGHT);
  ...
  if (saveManifold) {
    KeenManifold manifold = generator.create_manifold(maxE, {}, true, opts.dtWeight);
