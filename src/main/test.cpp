...
{
  Manifold keenM(generator, E, filter, predictionSet, copredictMode, false);
  Manifold lazyM(generator, E, filter, predictionSet, copredictMode, true);
                          ...
                          bool copredictMode = false)
{
  ...
  check_lazy_manifold(generator, E, filter, false, copredictMode);
  check_lazy_manifold(generator, E, filter, true, copredictMode);
}
...
TEST_CASE("Basic manifold creation", "[basicManifold]")
{
  ...
  SECTION("Manifold with dt (not allowing missing)")
  {
    ...
    ManifoldGenerator generator(t, x, tau, p, {}, {}, {}, {}, 0, dtMode, false, allowMissing, dtWeight);
...
TEST_CASE("Missing data manifold creation (tau = 1)", "[missingDataManifold]")
{
  ...
  SECTION("reldt")
  {
    ...
    double dtWeight = 1.0;
    bool allowMissing = false;
    ManifoldGenerator generator(t, x, tau, p, {}, {}, {}, {}, 0, dtMode, reldtMode, allowMissing, dtWeight);
...
TEST_CASE("Lazy L^p distances", "[lazy_lp_distances]")
{
  ...
  bool lazy = true;
  Manifold M(generator, E, usable, false, false, lazy);
  Manifold Mp(generator, E, usable, true, false, lazy);
...
TEST_CASE("Wasserstein distance", "[wasserstein]")
{
  ...
  double dtWeight = 1.0;
  ManifoldGenerator generator(t, x, tau, p, xmap, co_x, {}, {}, 0, dt, reldt, allowMissing, dtWeight);
  ...
  bool copredict = true;
  Manifold M(generator, E, usable, false, copredict);
  Manifold Mp(generator, E, usable, true, copredict);
  check_usable_matches_prediction_set(usable, Mp);
...
TEST_CASE("Coprediction and usable/library set/prediction sets", "[copredSets]")
{
  ...
  check_lazy_manifolds(generator, E, cousable, true);
  ...
  {
    bool copredict = true;
    Manifold M_co(generator, E, usable, false, copredict);
    Manifold Mp_co(generator, E, cousable, true, copredict);
